...
echo 'curl --connect-timeout 5 --speed-time 5 --retry 10 https://github.com/martymac/fpart/archive/fpart-0.9.3.zip -o deployment/dist/fpart.zip'
curl --connect-timeout 5 --speed-time 5 --retry 10 https://github.com/martymac/fpart/archive/fpart-0.9.3.zip -o deployment/dist/fpart.zip
